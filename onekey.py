...
''')
					...
					if repo == "1":
						...
						cmd1 = os.system("apt-get install -y --allow-unauthenticated gparted zim amule skype redshift x11vnc remmina ssvnc htop shutter gdebi bleachbit gedit fcitx-sunpinyin fcitx-googlepinyin fcitx-module-cloudpinyin fcitx fcitx-config-common kchmviewer synaptic software-center fcitx-config-gtk libmysqlclient-dev zlib1g-dev automake checkinstall vlc python-pip python3-pip vim mysql-server mysql-client apache2")
						cmd2 = os.system("apt-get install -y --allow-unauthenticated eclipse qemu-kvm libvirt-bin virt-manager bridge-utils labyrinth smplayer amarok chromium-browser filezilla putty git spyder ninja-ide idle-python3.5 rar unrar geany idle-python2.7 emacs spe eric spyder3 php7.0 fbreader vym semantik filelight mysql-workbench arduino codeblocks libapache2-mod-php7.0 php7.0-mysql")
