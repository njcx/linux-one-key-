...
''')
					...
					if repo == "1":
						...
						cmd1 = os.system("apt-get install -y --allow-unauthenticated gparted x11vnc remmina ssvnc clusterssh shutter gdebi bleachbit gedit fcitx-sunpinyin fcitx-googlepinyin fcitx-module-cloudpinyin fcitx fcitx-config-common kchmviewer synaptic software-center fcitx-config-gtk vlc python-pip python3-pip vim mysql-server mysql-client apache2 ")
